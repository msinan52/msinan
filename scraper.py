...
colleges = {"580":("MIT",16),"1222":("Yale",23),"181":("CMU",28), "1085":("UChicago",28),"1040":("Tufts",46), "1350":("Duke",84),"1255":("UTexas",84),"953":("Stanford",32),"799":("Rice",17),"780":("Princeton",16),"137":("Brown",24), "278":("Columbia",36), "298":("Cornell",104), "1339":("Dartmouth",12), "399":("Harvard",24), "1275":("UPennsylvania",30)}
